...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../Users/vasil/bin/Sencha/Cmd/6.1.1.76/plugins/src",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Contacts.controller.RdgController": [],
  "Contacts.controller.SearchController": [],
  "Contacts.model.LoginModel": [],
  "Contacts.model.PodModel": [],
  "Contacts.model.UserModel": [],
  "Contacts.store.DetailCardJsonPStore": [],
  "Contacts.store.IagJsonPStore": [],
  "Contacts.store.LoginStore": [],
  "Contacts.store.PodJsonPStore": [],
  "Contacts.store.PodSubJsonPStore": [],
  "Contacts.store.PodUserJsonPStore": [],
  "Contacts.store.SearchJsonPStore": [],
  "Contacts.view.AboutPanel": [],
  "Contacts.view.DetailCardDataView": [],
  "Contacts.view.HomePanel": [],
  "Contacts.view.IagList": [],
  ...
  "Contacts.view.PodList": [],
  "Contacts.view.PodNavView": [],
  "Contacts.view.PodSubList": [],
  "Contacts.view.PodUserList": [],
  "Contacts.view.RdgList": [],
  "Contacts.view.RdgNavView": [],
  "Contacts.view.SearchFormPanel": [],
  "Contacts.view.SearchNavView": [],
  "Contacts.view.SearchResultUserList": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Contacts.view.SearchFormPanel": [
    "widget.searchformpanel"
  ],
  "Contacts.view.SearchNavView": [
    "widget.searchnavview"
  ],
  "Contacts.view.SearchResultUserList": [
    "widget.searchresultuserlist"
  ],
  "Ext.AbstractComponent": [],
  "Ext.AbstractManager": [],
  "Ext.AbstractPlugin": [],
